...
Template.repositories_row.events({
    'blur button[name="editRepo"], click button[name="editRepo"]': function tplRowRepositoriesClickEditRepo(ev, tpl) {
...
Template.packages_row.events({
    'blur button[name="editPackage"], click button[name="editPackage"]': function tplRowPackagesClickEditPackage(ev, tpl) {
        var data = {
